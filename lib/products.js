...
const BUNDLE_LIST = [
  { slug: 'river3-110', cat: 'emergencia', station: 'RIVER 3', panel: 'Panel Solar EcoFlow 110W', si: '/products/img-19.png', pi: '/products/img-01.png', price: '$9,999', carga: '2.6 h', cap: '230 Wh', out: '300 W', times: ['16 h', '8.9 h', '6.1 h', '2.5 h'] },
  { slug: 'river3plus-220', cat: 'emergencia', station: 'RIVER 3 Plus', panel: 'Panel Solar EcoFlow 220W Ligero', si: '/products/img-18.png', pi: '/products/img-13.png', price: '$12,999', carga: '98 min', cap: '286 Wh', out: '600 W', times: ['20 h', '11 h', '7.6 h', '3.2 h'] },
  { slug: 'river2max-220', cat: 'homeoffice', station: 'RIVER 2 Max', panel: 'Panel Solar EcoFlow 110W', si: '/products/img-14.png', pi: '/products/img-01.png', price: '$13,499', carga: '5.8 h', cap: '512 Wh', out: '500 W', times: ['9.7 h', '7.6 h', '5.3 h', '3.3 h', '2.1 h'] },
  { slug: 'river3max-220', cat: 'homeoffice', station: 'RIVER 3 Max', panel: 'Panel Solar EcoFlow 110W', si: '/products/img-17.png', pi: '/products/img-01.png', price: '$14,599', carga: '6.6 h', cap: '572 Wh', out: '600 W', times: ['11 h', '8.5 h', '5.9 h', '3.7 h', '2.3 h'] },
  { slug: 'river2pro-220', cat: 'homeoffice', station: 'RIVER 2 Pro', panel: 'Panel Solar EcoFlow 110W', si: '/products/img-15.png', pi: '/products/img-01.png', price: '$14,999', carga: '8.8 h', cap: '768 Wh', out: '800 W', times: ['15 h', '11 h', '8.0 h', '4.9 h', '3.1 h'] },
  { slug: 'river3maxplus-220', cat: 'homeoffice', station: 'RIVER 3 Max Plus', panel: 'Panel Solar EcoFlow 220W Ligero', si: '/products/img-16.png', pi: '/products/img-13.png', price: '$19,299', carga: '4.9 h', cap: '858 Wh', out: '600 W', times: ['16 h', '13 h', '8.9 h', '5.5 h', '3.4 h'] },
  { slug: 'delta2black-400', cat: 'esenciales', station: 'DELTA 2 Black', panel: 'Panel Solar Rígido 400W', si: '/products/img-24.png', pi: '/products/img-02.png', price: '$21,099', carga: '3.1 h', cap: '980 Wh', out: '500 W', times: ['6.9 h', '6.3 h', '5.1 h', '3.4 h', '2.9 h'] },
  { slug: 'delta3-400', cat: 'esenciales', station: 'DELTA 3', panel: 'Panel Solar Rígido 400W', si: '/products/img-11.png', pi: '/products/img-02.png', price: '$27,199', carga: '3.2 h', cap: '1,024 Wh', out: '1,800 W', times: ['7.3 h', '6.6 h', '5.4 h', '3.6 h', '3.0 h'] },
  { slug: 'delta3plus-rigido400', cat: 'esenciales', station: 'DELTA 3 Plus + Batería Extra', panel: 'Panel Solar Rígido 400W', si: '/products/img-11.png', pi: '/products/img-02.png', price: '$36,399', carga: '6.4 h', cap: '2,048 Wh', out: '1,800 W', times: ['15 h', '13 h', '11 h', '7.2 h', '6.1 h'] },
  { slug: 'delta2max-rigido400', cat: 'esenciales', station: 'DELTA 2 Max', panel: 'Panel Solar Rígido 400W', si: '/products/img-08.png', pi: '/products/img-02.png', price: '$33,999', carga: '6.4 h', cap: '2,048 Wh', out: '2,400 W', times: ['15 h', '13 h', '11 h', '7.2 h', '6.1 h'] },
  { slug: 'deltapro-rigido400', cat: 'residencial', station: 'DELTA Pro', panel: 'Panel Solar Rígido 400W', si: '/products/img-12.png', pi: '/products/img-02.png', price: '$47,999', carga: '11 h', cap: '3,600 Wh', out: '3,600 W', times: ['26 h', '14 h', '11 h', '3.9 h', '2.4 h'] },
  { slug: 'deltapro3-rigido400', cat: 'residencial', station: 'DELTA Pro 3', panel: 'Panel Solar Rígido 400W', si: '/products/img-25.png', pi: '/products/img-02.png', price: '$77,999', carga: '13 h', cap: '4,096 Wh', out: '4,000 W', times: ['29 h', '16 h', '12 h', '4.5 h', '2.7 h'] },
  { slug: 'deltaproultra-rigido400', cat: 'residencial', station: 'DELTA Pro Ultra', panel: 'Panel Solar Rígido 400W', si: '/products/img-10.png', pi: '/products/img-02.png', price: '$101,999', carga: '19 h', cap: '6 kWh+', out: '7,200 W+', times: ['43 h', '23 h', '18 h', '6.5 h', '4.0 h'] },
  { slug: 'delta3max-400', cat: 'esenciales', station: 'DELTA 3 Max', panel: 'Panel Solar Rígido 400W', si: '/products/img-11.png', pi: '/products/img-02.png', price: '$35,899', carga: '6.4 h', cap: '2,048 Wh', out: '3,000 W', times: ['15 h', '13 h', '11 h', '7.2 h', '6.1 h'] }
];
...
// Which category a product belongs to. `isBundle` selects the card component
// on the detail page (bundles use the two-photo PackageCard); `path` powers
// the breadcrumb back to the matching listing page.
export function productCategory(slug) {
  if (bundles.some((p) => p.slug === slug)) {
    return { key: 'paquetes', path: '/paquetes', es: 'Paquetes', en: 'Bundles', isBundle: true };
  }
  if (solarPanels.some((p) => p.slug === slug)) {
    return { key: 'paneles', path: '/paneles', es: 'Paneles solares', en: 'Solar panels', isBundle: false };
  }
  if (batteries.some((p) => p.slug === slug)) {
    return { key: 'baterias', path: '/baterias', es: 'Baterías', en: 'Batteries', isBundle: false };
  }
  if (smartProducts.some((p) => p.slug === slug)) {
    return { key: 'inteligentes', path: '/inteligentes', es: 'Inteligentes', en: 'Smart', isBundle: false };
  }
  return { key: 'estaciones', path: '', es: 'Estaciones', en: 'Power stations', isBundle: false };
}
