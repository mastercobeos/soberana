...
export function termsSections(locale) {
  ...
  return {
    ...
    intro: isEs
      ? 'Reglas generales para el uso del sitio, la compra en línea de productos, precios, pagos, entregas, garantías y devoluciones.'
      : 'General rules for using the site, buying products online, pricing, payments, delivery, warranties, and returns.',
    updatedLabel: isEs ? 'Última actualización: 7 de julio de 2026' : 'Last updated: July 7, 2026',
    note: isEs ? (
      <span>
    ...
    sections: isEs
      ? [
          ...
          { title: '2. Naturaleza del sitio', paragraphs: ['Este sitio funciona como catálogo y tienda en línea de soluciones de energía, paneles, baterías, paquetes y accesorios, donde el usuario puede comprar directamente. La publicación de productos no constituye por sí misma una oferta irrevocable ni garantiza disponibilidad inmediata.'] },
          ...
          { title: '4. Compra en línea, pago, cotizaciones y pedidos', paragraphs: [
            'El usuario puede comprar productos directamente en el sitio. El pago se procesa de forma segura a través de Stripe; Soberana Solutions no almacena los datos de la tarjeta. Un pedido se considera confirmado cuando el pago se completa correctamente.',
            'También pueden solicitarse cotizaciones, que deberán confirmarse por escrito e indicar producto, precio, vigencia, forma de pago, disponibilidad y condiciones particulares. Tras confirmar el pago, Soberana Solutions se pondrá en contacto con el usuario para coordinar la entrega.'
          ] },
          ...
          { title: '7. Envíos, entregas y disponibilidad bajo pedido', paragraphs: [
            'Después de confirmar el pago, Soberana Solutions contactará al usuario mediante los datos proporcionados para coordinar la entrega. Los productos pueden manejarse bajo pedido.',
            'Los tiempos de entrega dependen del inventario, la logística, la zona geográfica, la disponibilidad del proveedor y causas externas, por lo que no se garantiza una fecha específica; el plazo estimado se informará al coordinar la entrega.'
          ] },
          { title: '8. Cambios, cancelaciones y devoluciones', paragraphs: ['Las condiciones de cambios, cancelaciones y devoluciones se atenderán conforme a la legislación aplicable en materia de protección al consumidor. Para iniciar una solicitud, el usuario debe contactarnos con su comprobante de compra. Algunos productos bajo pedido, instalados, usados, abiertos o configurados pueden estar sujetos a restricciones permitidas por la ley.'] },
      ...
      : [
          ...
          { title: '2. Nature of the site', paragraphs: ['This site works as a catalog and online store for energy solutions, panels, batteries, bundles, and accessories, where the user can purchase directly. Publishing products does not constitute an irrevocable offer nor guarantee immediate availability.'] },
          ...
          { title: '4. Online purchase, payment, quotes, and orders', paragraphs: [
            'Users may purchase products directly on the site. Payment is processed securely through Stripe; Soberana Solutions does not store card data. An order is considered confirmed once payment is successfully completed.',
            'Quotes may also be requested and must be confirmed in writing, indicating product, price, validity, payment method, availability, and special conditions. After payment is confirmed, Soberana Solutions will contact the user to coordinate delivery.'
          ] },
          ...
          { title: '7. Shipping, delivery, and on-order availability', paragraphs: [
            'After payment is confirmed, Soberana Solutions will contact the user using the information provided to coordinate delivery. Products may be handled on order.',
            'Delivery times depend on inventory, logistics, geographic area, supplier availability, and external causes, so a specific date is not guaranteed; the estimated timeframe will be communicated when coordinating delivery.'
          ] },
          { title: '8. Changes, cancellations, and returns', paragraphs: ['Exchange, cancellation, and return conditions are handled in accordance with applicable consumer protection law. To start a request, the user must contact us with their proof of purchase. Some on-order, installed, used, opened, or configured products may be subject to restrictions permitted by law.'] },
